...
//   - Statics are DIRECT on the imported handle (`Mth.clamp(...)`) — unlike
//     the ambient class globals, which are raw java.lang.Class values whose
//     statics live behind `.static` (`Mth.static.clamp(...)`). Both are
//     typed accurately as of @wunk/lb-script-api-types 0.38.3.
